...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  controller.o gate.o lock.o queue.o register.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#=
...
#^|
controller.o: /cygdrive/C/eclipse/workspace/Panama_Canal/controller.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
gate.o: /cygdrive/C/eclipse/workspace/Panama_Canal/gate.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
lock.o: /cygdrive/C/eclipse/workspace/Panama_Canal/lock.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
queue.o: /cygdrive/C/eclipse/workspace/Panama_Canal/queue.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/Panama_Canal/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
controller.o: \
 /cygdrive/C/eclipse/workspace/Panama_Canal/controller.cpp \
 /cygdrive/C/eclipse/workspace/Panama_Canal/controller.h \
...
gate.o: /cygdrive/C/eclipse/workspace/Panama_Canal/gate.cpp \
 /cygdrive/C/eclipse/workspace/Panama_Canal/gate.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
lock.o: /cygdrive/C/eclipse/workspace/Panama_Canal/lock.cpp \
 /cygdrive/C/eclipse/workspace/Panama_Canal/lock.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
queue.o: /cygdrive/C/eclipse/workspace/Panama_Canal/queue.cpp \
 /cygdrive/C/eclipse/workspace/Panama_Canal/queue.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
